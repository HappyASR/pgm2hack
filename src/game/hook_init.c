...
//------------------
#define	v2001058						DU8(0x2001058)//
#define	v20020484						DU8(0x20020484)//Region
#define	vMainFsm						DU8(0x20020104)//主状态机
#define	v20020105						DU8(0x20020105)//
#define	v20020106						DU8(0x20020105)//
#define	v20020107						DU8(0x20020107)//
#define	v2002010A						DU8(0x2002010A)//
#define	v2002045A						DU8(0x2002045A)//
#define	v200203FC						DU8(0x200203FC)//

#define	p20020398						PU32(0x20020398)//
#define	p200203E2						PU32(0x200203E2)//这个有关是否能选唐僧
#define	p200203C6						PU32(0x200203C6)//
#define	p2002039C						PU32(0x2002039C)//
#define	p20061C6C						PU32(0x20061C6C)//
#define	p20061DFC						PU32(0x20061DFC)//
#define	p20061ADC						PU32(0x20061ADC)//
#define	p20061AB4						PU32(0x20061AB4)//

#define	p1012D980						PU32(0x1012D980)//
#define	p10433B68						PU32(0x10433B68)//
#define	p10433768						PU32(0x10433768)//
#define	p10433868						PU32(0x10433868)//
#define	p10433968						PU32(0x10433968)//
#define	p10433F68						PU32(0x10433F68)//
#define	p10433C68						PU32(0x10433C68)//
#define	p10433E68						PU32(0x10433E68)//
#define	p10434068						PU32(0x10434068)//
#define	p10434168						PU32(0x10434168)//
#define	p10431A68						PU32(0x10431A68)//
#define	p1042F668						PU32(0x1042F668)//
#define	p1042F768						PU32(0x1042F768)//
#define	p10430768						PU32(0x10430768)//
#define	p10430968						PU32(0x10430968)//
#define	p10430A68						PU32(0x10430A68)//
#define	p10430B68						PU32(0x10430B68)//
#define	p10430C68						PU32(0x10430C68)//
#define	p10395AB4						PU32(0x10395AB4)//
#define	p10395BB4						PU32(0x10395BB4)//
#define	p10395CB4						PU32(0x10395CB4)//
#define	p10395DB4						PU32(0x10395DB4)//
#define	p10395EB4						PU32(0x10395EB4)//
#define	p10175F54						PU32(0x10175F54)//
