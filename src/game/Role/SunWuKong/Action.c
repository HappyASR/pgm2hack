...
const ActTypePtrTbl const Role_SunWuKong_ActPtrTbl_0 ={
		0,
		SunWuKong_ActType_Start,		//(ActElem*)0x10700030,
		SunWuKong_ActType_Motion,		//(ActElem*)0x10702AD8,
		SunWuKong_ActType_Attack,		//(ActElem*)0x10703B9C,
		SunWuKong_ActType_Type4,		//(ActElem*)0x10705170,
		SunWuKong_ActType_Type5,		//(ActElem*)0x10706AD8,
		SunWuKong_ActType_Kill,		//(ActElem*)0x10707918,
		0,
		SunWuKong_ActType_Caning,		//(ActElem*)0x1070BA80,
		SunWuKong_ActType_Victor,		//(ActElem*)0x1070D000,
		0,
		0
};
