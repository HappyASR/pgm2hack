...
#define ReadICCardData FUNC16(0x1000f328)
...
#define ExecSystemOBJ FUNC16(0x1001081a)
...
#define UseRoro FUNC16(0x1001a00a)
...
#define SetRoro FUNC16(0x1001a902)
...
#define GetRoroInfoRAM FUNC16(0x1002066c)
...
#define GetPlayerInfo FUNC16(0x100236a0)
...
#define GetPlayerCnt FUNC16(0x1002b736)
...
#define MovePlayer FUNC16(0x1002bd0a)
...
#define ScreenUpdate FUNC16(0x1002f81a)//屏幕刷新
...
#define ExecDialogLeft FUNC16(0x1004939a)
#define ExecDialogRight FUNC16(0x100496aa)
...
#define SetMotionTimer FUNC16(0x1004c9d0)//场景倒计时
...
#define SetMapBitPal FUNC16(0x1004f8d0)
...
#define LoadMapMask FUNC16(0x1004fa0c)
#define LoadMapBit FUNC16(0x1004fb20)
...
#define LoadRoroCMD FUNC16(0x1005854c)
#define ExecRoroCMD FUNC16(0x100585aa)
...
#define StopPlayerCtrl FUNC16(0x1005c0de)
...
#define GetRoleInfoRAM FUNC16(0x10065538)
...
#define CreatItemBox FUNC16(0x1008ff0a)
...
#define GoMessage FUNC16(0x1009170a)
...
#define GetRoleInBox FUNC16(0x100918f6)
...
#define GetJingShuCnt FUNC16(0x1010f150)
...
#define g_MAIN_FSM	DU8(0x20020104)//主状态机
#define	g_GAME_MODE	DU8(0x20020105)//游戏模式
#define isQCMode	DU8(0x20020107)//

#define gDstX		DU16(0x20020154)//目标X坐标
#define gDstY		DU16(0x20020156)//目标Y坐标
