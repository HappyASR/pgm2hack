...
//--------以下为重新绘制的选人界面
  ...
  PalFade_10004E76(1, 0, 8);//淡入进来
	...
	for (j=0;j<10 ;j++ ) //绘制小头像
	{
		...
		if (j % 2)
		{
			P32(0x20061AB4)[j] = CreatOBJ_100813E0(0, 251, -5, P16(0x10175D68)[j], 4, 300, 0);//画左边头像
			P32(0x20061AB4)[j+10] = CreatOBJ_100813E0(0, 251+58, -5, P16(0x10175D68)[j], 4, 300, 0);//画左边头像
			P32(0x20061AB4)[j+20] = CreatOBJ_100813E0(0, 251+58+58, -5, P16(0x10175D68)[j], 4, 300, 0);//画左边头像
		}
		else
		{
			P32(0x20061AB4)[j] = CreatOBJ_100813E0(0, 193, 255, P16(0x10175D68)[j], 4, 300, 0);//画右边头像
			P32(0x20061AB4)[j+10] = CreatOBJ_100813E0(0, 193-58, 255, P16(0x10175D68)[j], 4, 300, 0);//画右边头像
			P32(0x20061AB4)[j+20] = CreatOBJ_100813E0(0, 193-58-58, 255, P16(0x10175D68)[j], 4, 300, 0);//画右边头像
		}
