/*
		...
		ChangemenInfoAddr = 0x10298C14

*/

#include "../../Include/Role.h"

const Role changemen_8_0={
				...
				0x1029880C,		//int pImageIdTbl

				0x102986A0,		//int pPalTbl

	(InputElem*)0x10298B88,		//int pInputTbl
				...
				0x10298BE0,		//int pSkillCancleTbl
